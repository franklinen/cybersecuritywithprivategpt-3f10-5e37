Scaling [cybersecuritywithprivategpt-3f10-5e37] With Kubernetes
===========================
...
Based on your TML solution [cybersecuritywithprivategpt-3f10-5e37] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecuritywithprivategpt-3f10-5e37.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecuritywithprivategpt-3f10-5e37.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecuritywithprivategpt-3f10-5e37.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f cybersecuritywithprivategpt-3f10-5e37.yml

cybersecuritywithprivategpt-3f10-5e37.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecuritywithprivategpt-3f10-5e37.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/franklinen/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-3f10/ymls/cybersecuritywithprivategpt-3f10-5e37
...
.. code-block:: YAML
   ...
   ################# cybersecuritywithprivategpt-3f10-5e37.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecuritywithprivategpt-3f10-5e37
     spec:
       selector:
         matchLabels:
           app: cybersecuritywithprivategpt-3f10-5e37
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecuritywithprivategpt-3f10-5e37
             image: frank19831207/cybersecuritywithprivategpt-3f10-5e37-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'cybersecuritywithprivategpt-3f10-5e37'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-cybersecuritywithprivategpt-3f10'
             - name: GITUSERNAME
               value: 'franklinen'
             - name: GITREPOURL
               value: 'https://github.com/smaurice101/raspberrypi.git'
             ...
             - name: step2preprocess_data_topic # STEP 2 
               value: 'cisco-network-preprocess'                           
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecuritywithprivategpt-3f10-5e37-visualization-service
       labels:
         app: cybersecuritywithprivategpt-3f10-5e37-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecuritywithprivategpt-3f10-5e37 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecuritywithprivategpt-3f10-5e37.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecuritywithprivategpt-3f10-5e37.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecuritywithprivategpt-3f10-5e37.yml
