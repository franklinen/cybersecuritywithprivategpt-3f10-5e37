...
def setupurls(projectname,producetype,sname):
    ...
    stepurl10="https://github.com/{}/{}/tree/main/tml-airflow/dags/tml-solutions/{}/tml_system_step_10_documentation_dag_tml-multi-agenticai-iot-3f10-5e37-{}.py".format(os.environ['GITUSERNAME'],tsslogging.getrepo(),projectname,projectname)
